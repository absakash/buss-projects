            ...
            {data.schedule[userDate]?.map((train, index) => {
              ...
              if (
                ...
                return (
                  ...
                  >
                    <p className="text-lg md:text-3xl font-semibold mb-2 text-center">
                      {train.trainName}
                    </p>
                    ...
                    <p onClick={() => handleBookSit(train)} className="btn btn-outline bg-purple-50">Book Ticket</p>
                  </div>
                );
              }
